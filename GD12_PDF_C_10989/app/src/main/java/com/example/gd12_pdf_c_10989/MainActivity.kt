package com.example.gd12_pdf_c_10989
...
import com.example.gd12_pdf_c_10989.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding!!.buttonSave.setOnClickListener{
            val nama = binding!!.editTxtName.text.toString()
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        ...
        val file = File(pdfPath,"Pdf_10989.pdf")
